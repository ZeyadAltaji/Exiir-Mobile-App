...
class Bookingsummary extends StatelessWidget {
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              TextButton(
                ...
                child: buildAirportSelector(
                  AirportInfo(
                    translationController.Translate(station.csNameAr!, station.csName!),
                    translationController.getLanguage(106),
                  ),
                  FontAwesomeIcons.chargingStation,
                ),
              ...
              TextButton(
                ...
                onPressed: () {},
                  child: buildDateSelector(
                      translationController.getLanguage(104).trim(),  booking.BookingDate),
              ),
                TextButton(
                style: TextButton.styleFrom(
                  backgroundColor: Colors.white,
                ...
                onPressed: () {},
                  child: buildDateSelector(
                      translationController.getLanguage(105).trim(), booking.BookingDate),
              ),
 ...
 Widget buildtimeSelector(String title, DateTime dateTime,{bool showTime = false, required String timeLabel}) {
  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: <Widget>[
      Text(
